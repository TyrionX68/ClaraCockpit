...
const ClaraAnchorDashboard = () => {
  // Dummy-Daten basierend auf UI-Anker-Version
  const kpiData = {
    objekteVerwaltet: { value: 1, label: "Waldhofstraße 76", icon: Building2 },
    mieterGesamt: { value: 14, label: "100% Vermietungsgrad", icon: Users },
    monatlicheMiete: { value: "8.360€", label: "Gesamteinnahmen", icon: Euro },
    jahresrendite: { value: "8.4%", label: "Über Marktdurchschnitt", icon: TrendingUp }
  };
  ...
  const sidebarSections = [
    {
      ...
      items: [
        ...
        { name: "Eigentümer", icon: Users },
        { name: "Objekte", icon: Building2 },
        { name: "Rückstände", icon: AlertTriangle },
        { name: "Zahlungen", icon: Euro },
    ...
    },
    {
      ...
      items: [
        { name: "Mieter-Kommunikation", icon: MessageSquare },
        { name: "Clara KI", icon: Bot },
        { name: "Outlook", icon: MessageSquare }
      ]
    },
    {
      title: "SYSTEM",
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
                  ...
                  <li key={itemIdx}>
                    <Button
                      ...
                      className={`w-full justify-start gap-3 h-9 ${
                        item.active ? 'bg-blue-50 text-blue-700 border border-blue-200' : 'text-gray-600'
                      }`}
                    >
      ...
      <main className="flex-1 p-6">
        ...
        {/* KPI Cards - 2x2 Grid wie UI-Anker */}
        ...
        {/* Bottom Section - Rückstände & Finanzübersicht */}
...
export default ClaraAnchorDashboard;
